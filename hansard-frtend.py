...
#         os.system('xterm -into %d -geometry 40x20 -sb &' % wid)
    ...
    def OnButtonClick(self):
        ...
        searchcritDir = "/home/vijay/Documents/Strath/hansard/search-criteria/"

        if os.path.exists(searchcritDir) is False:
          call(['mkdir',searchcritDir])

        # Set storage directory
        storeDir = '/home/vijay/Documents/Strath/hansard/stores/'

        if os.path.exists(storeDir) is False:
          call(['mkdir',storeDir])

        # Set search storage directory
        searchDir = "/home/vijay/Documents/Strath/hansard/stores/searches/"

        if os.path.exists(searchDir) is False:
          call(['mkdir',searchDir])

        # Set text directory
        textDir = "/home/vijay/Documents/Strath/hansard/stores/text/"

        if os.path.exists(textDir) is False:
          call(['mkdir',textDir])

        # Set database directory
        dataDir = "/home/vijay/Documents/Strath/hansard/databases/"
...
if __name__ == "__main__":
    ...
    img = tkinter.PhotoImage(file='/home/vijay/Documents/Strath/scripts/python/parliament-uk-logo.gif')
